...
/** Copyright text view. */
@property (nonatomic, strong) UITextView *copyrightTextView;
...
- (void)viewDidLayoutSubviews
{
    ...
    if (self.copyrightTextView.superview == nil && self.copyrightText != nil) {
        CGPoint center = self.imageView.center;
        CGFloat height = self.imageView.image.size.height * self.view.frame.size.width / self.imageView.image.size.width;
        center.y += height / 2 + 12;
        
        self.imageView.userInteractionEnabled = YES;
        self.copyrightTextView = [[UITextView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width - 8, 28)];
        [self.imageView addSubview: self.copyrightTextView];
        self.copyrightTextView.center = center;
        self.copyrightTextView.attributedText = self.copyrightText;
        self.copyrightTextView.textColor = [UIColor lightGrayColor];
        self.copyrightTextView.textAlignment = NSTextAlignmentRight;
        self.copyrightTextView.backgroundColor = [UIColor clearColor];
        
        self.copyrightTextView.userInteractionEnabled = YES;
        [self.copyrightTextView setEditable: NO];
    }
...
- (UIImage *)editedImage
{
    ...
    if ([self isIPad] && self.cropMode == DZNPhotoEditorViewControllerCropModeCircular) {
